...
let contents = document.querySelectorAll('.content-articles, .content-videos, .content-slides, .content-podcasts');
let contentsDefis = document.querySelectorAll('.content-penseealgorithmique, .content-python, .content-linux, .content-langager, .content-basededonnees');
...
// console.log('contentsDefis:', contentsDefis)

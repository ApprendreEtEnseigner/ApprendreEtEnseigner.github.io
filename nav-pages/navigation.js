...
let contentsDefis = document.querySelectorAll(
  ".content-penseealgorithmique, .content-technicieninformatique, .content-devwebfrontend, .content-python, .content-linux, .content-langager, .content-basededonnees, .content-biomol"
);
